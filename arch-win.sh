...
mount_partitions(){
  ...
  #mount -o defaults,noatime,compress-force=zstd:3,autodefrag,subvol=@log /dev/sda7 /mnt/var/log
  #mount -o defaults,noatime,compress-force=zstd:3,autodefrag,subvol=@pkg /dev/sda7 /mnt/var/cache/pacman/pkg
